      ...
      if (item.children) {
        ...
        return (
          <ExternalLink
            ...
            target="_blank"
          >
            <ButtonBase key={item.name} name="child" sx={{ width: '100%', background: '#017550', }}>
              {(() => {
                if (item.icon) {
        ...
        return (
          <InternalLink key={index}>
            ...
            >
              <ButtonBase key={item.name} name="child" sx={{ width: '100%' , background: '#017550',}}>
                {item?.icon ? (
                  <Icon className="icon" sx={{ width: 36 , background: '#017550',}}>
                    {item.icon}
                  </Icon>
                ) : (
                  <Fragment>
                    <BulletIcon
                      ...
                      sx={{ display: mode === 'compact' && 'none' , background: '#017550',}}
                    />
                    <Box
